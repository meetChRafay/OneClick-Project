...
Next.js 16 (App Router, Server Actions, Turbopack) · React 19 · TypeScript · Tailwind CSS v4 · Radix UI · Supabase (`@supabase/ssr`, `@supabase/supabase-js`) · `next-themes` · `date-fns` · `sonner` · `cmdk`.
